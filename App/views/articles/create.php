...
<div class="col-md-10 offset-md-1">
    ...
    <form action="<?php $article->store(); ?>" method="POST" enctype ='multipart/form-data'>
        ...
        <textarea class="form-control" name="article" id="" cols="30" rows="10"></textarea>
        <input type="file" name="file-image"><br><br>
